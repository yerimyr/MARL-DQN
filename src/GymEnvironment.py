...
class InventoryManagementEnv(gym.Env):
    ...
    def __init__(self):
        ...
        for _ in range(MAT_COUNT):
            obs_dims.append(INVEN_LEVEL_MAX - INVEN_LEVEL_MIN + 1)  # (Environment.py, Class Procurement)
        # Remaining demand
        obs_dims.append(INVEN_LEVEL_MAX - INVEN_LEVEL_MIN + 1)  # if demand > INVEN_LEVEL_MAX: return INVEN_LEVEL_MAX (config_SimPy.py, def DEMAND_QTY_FUNC())
